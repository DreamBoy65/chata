...
function _addComponent(app, component) {
  try {
    ...
    logger.debug(`Component ${component.name} failed to register with FirebaseApp ${app.name}`,
      e);
  }
}
/**
...
version: 2, heartbeats: heartbeatsToSend
}));
...
JSON.stringify({
version: 2, heartbeats: heartbeatsCache
})).length;
}
